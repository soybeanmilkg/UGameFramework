...
UGameExperienceDefinition::UGameExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UGameExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UGameExperienceDefinition::UpdateAssetBundleData()
{
