 ...
 */
UCLASS()
class GAMEEXPERIENCE_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
private:
	...
	void Step3_HandleExperienceLoaded(const UGameExperienceDefinition* CurrentExperience);
