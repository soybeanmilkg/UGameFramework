...
#include "ExtensionGameFeaturePolicy.generated.h"
...
class UExtensionGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	GAMEFEATUREEXTENSION_API static UExtensionGameFeaturePolicy& Get();

	explicit UExtensionGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class UExtensionGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
